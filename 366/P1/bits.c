...
//	int mask, mMask, nMask;
//
//	bitsToShiftM = m << 3;
//	mMask = 0xff << bitsToShiftM;
//	mByte = x >> bitsToShiftM;
//
//	bitsToShiftN = n << 3;
//	nMask = 0xff << bitsToShiftN;
//	nByte = x >> bitsToShiftN;
//
//	mask = mMask | nMask;
//	xWithBytesRemoved = x & ~mask;
//	return xWithBytesRemoved | ((nByte << bitsToShiftM) & mMask) | ((mByte << bitsToShiftN) & nMask);
}
