...
# William Montgomery
# wmontg2
# Descriptions of IADDL and LEAVE are attached as PDF documents.
####################################################################
...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL, ILEAVE }; #TODO
...
int aluA = [
	...
	icode in { IRET, IPOPL, ILEAVE } : 4; #TODO
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL, ILEAVE} : valB; #TODO
...
bool mem_read = icode in { IMRMOVL, IPOPL, IRET, ILEAVE }; #TODO
...
int mem_addr = [
	...
	icode in { IPOPL, IRET, ILEAVE } : valA; #TODO
