...
/*  CS450Header6.h
    ...
    This is version 6 of this header, with fields added to support reliable
...
#define CS450HEADER5_H
    ...
    // User `Constants
    static const int32_t VERSION = 6;
    static const int32_t UIN = 659756217;
    static const int8_t HW_NUMBER = 2;
    static const int8_t protocol = 22;
    static const char ACCC[8] = "wmontg2";
    static const int GARBLECHANCE = 20;
