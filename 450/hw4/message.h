...
private:
    ...
    unsigned int successfully_sent; /*!< The number of packets that were successfully sent */
...
public:
    ...
    Message* setAcked(unsigned int);
    bool isAcked(unsigned int i);
    bool isNotAcked(unsigned int i);
    bool isSent(unsigned int i);
    bool isNotSent(unsigned int i);
    Message *setSent(unsigned int i);
