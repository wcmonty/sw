...
#define CS450HEADER7_H
    ...
    typedef struct{
        ...
        int32_t sequenceNumber;    // User `Constants
...
//    const static int BLOCKSIZE = 3000;
    ...
    // User `Constants
    static const int32_t VERSION = 7;
    static const int32_t UIN = 659756217;
    static const int8_t HW_NUMBER = 3;
    static const int8_t PROTOCOL = 32;
