...
public:
    ...
    PacketWrapper* makeAck(unsigned int);
    ...
    int8_t getPacketType();
    PacketWrapper* setPacketType(int8_t);
    ...
    PacketWrapper* setDelayChance(int8_t);

    u_int8_t getWindowSize();
    PacketWrapper* setWindowSize(uint8_t);

    u_int8_t getProtocol();
    PacketWrapper* setProtocol(uint8_t);
    ...
    PacketWrapper* setSentTime();
    long int getTimeSinceSent();

    bool isSent();
    PacketWrapper* setSent();
