 ...
 * \return This
 */
PacketWrapper* PacketWrapper::makeAck(unsigned int ackNumber)
{
 ...
 */
int8_t PacketWrapper::getPacketType()
{
 ...
 * @return this
 */
PacketWrapper* PacketWrapper::setPacketType(int8_t type)
{
...
/**
 * @brief PacketWrapper::setDelayChance Setter for delayChance
 * @param chance delayChance
 * @return this
 */
PacketWrapper* PacketWrapper::setDelayChance(int8_t chance)
{
    if (chance > 100) chance = 100;
    this->packet.header.delayChance = chance;
    return this;
}

u_int8_t PacketWrapper::getWindowSize()
{
    return this->packet.header.windowSize;
}

/**
 * @brief PacketWrapper::setWindowSize Setter for windowSize
 * @param size windowSize
 * @return this
 */
PacketWrapper* PacketWrapper::setWindowSize(uint8_t size)
{
    this->packet.header.windowSize = size;
    return this;
}

/**
 * @brief PacketWrapper::getProtocol Getter for protocol
 * @return The protocol
 */
u_int8_t PacketWrapper::getProtocol()
{
    return this->packet.header.protocol;
}

/**
 * @brief PacketWrapper::setProtocol Setter for protocol
 * @param protocol The protocol
 * @return this
 */
PacketWrapper* PacketWrapper::setProtocol(uint8_t protocol)
{
    this->packet.header.protocol = protocol;
    return this;
}

/**
 * @brief PacketWrapper::getPacket Getter for packet
...
/**
 * @brief PacketWrapper::setSentTime Marks the sent time to now
 * @return this
 */
PacketWrapper* PacketWrapper::setSentTime()
{
...
/**
 * @brief PacketWrapper::getTimeSinceSent Returns the number of microseconds since the packet was sent
 * @return The number of microseconds since the packet was sent
 */
long int PacketWrapper::getTimeSinceSent()
{
    struct timeval now;
    gettimeofday(&now, NULL);
    return (now.tv_usec + 1000000 * now.tv_sec) - (sent_time.tv_usec + 1000000 * sent_time.tv_sec);
}

bool PacketWrapper::isSent()
{
    return this->sent;
}

PacketWrapper* PacketWrapper::setSent()
{
    this->sent = true;
    return this;
}
...
PacketWrapper* PacketWrapper::printHeader()
{
    ...
    cout << "delayChance: " << (int)packet.header.delayChance << endl;
    cout << "windowSize: " << (int)packet.header.windowSize << endl;
